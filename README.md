...
generated Typedoc reference (`pnpm docs:api` → `docs/api/`); this is the tight version.
...
> _0.2.0 is the first hardening release; see [`CHANGELOG.md`](./CHANGELOG.md) for the full list of changes._
